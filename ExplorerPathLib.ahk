/*
	From: https://autohotkey.com/board/topic/60985-get-paths-of-selected-items-in-an-explorer-window/
...
Explorer_GetSelectedOrPath(hwnd="")
{
	ret := Explorer_GetSelected(hwnd)
	if not ret
		ret := Explorer_GetPath(hwnd)
	return ret
}
